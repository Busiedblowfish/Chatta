...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div id="whole-box">
        <div class="groupChat-box">
                ...
                <div class="msg-box">
                    <asp:TextBox ID="TextBox1" style="resize:none" runat="server" Height="100%" Width="100%" MaxLength="160"
                        onKeyPress="javascript:howMany(this)" TextMode="MultiLine" Rows="3" Font-Names="Candara" Font-Size="Larger"></asp:TextBox>
                </div>
                <div class="send-box">
